...
![Daterange Picker](https://raw.githubusercontent.com/evansmwendwa/orch-daterangepicker/master/projects/orch-daterangepicker/assets/screen-shot.png)
...
```
npm install orch-daterangepicker
yarn add orch-daterangepicker
ng add orch-daterangepicker
```
...
{
  "styles": [
    "node_modules/orch-daterangepicker/assets/daterangepicker.css"
  ],
  "scripts": [
...
``` javascript
import { Daterangepicker } from 'orch-daterangepicker';
...
``` javascript
import { DaterangepickerConfig } from 'orch-daterangepicker';
...
import { DaterangePickerComponent } from 'orch-daterangepicker';
...
Run `ng build orch-daterangepicker` to build the project. The build artifacts will be stored in the `dist/` directory.

## Publishing

After building your library with `ng build orch-daterangepicker`, go to the dist folder `cd dist/orch-daterangepicker` and run `npm publish`.

## Running unit tests

Run `ng test orch-daterangepicker` to execute the unit tests via [Karma](https://karma-runner.github.io).
